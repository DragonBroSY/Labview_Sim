$PHASE SnapDecel_ATP length=-1       level=0 controlrelay=None common=0
#if ((SnapStage1 = 0) & AutoThrottle_F & ArmRunInHPC_TB)
+0 SET SnapStage1 5
+0 SET RunInStageTxt concat (StepTxt "Auto Snap Decel to ")
...
+0 SET SnapStage1 5
+0 SET BrkInStageTxt concat (StepTxt "Auto Snap Decel to ")
...
#elseif ((SnapStage1 = 0) & AutoThrottle_F)
+0 SET SnapStage1 5
