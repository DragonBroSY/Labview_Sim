$DISPLAY "Auxiliary" background=DarkGray loadflag=ctrlMEDRES_F editres=MEDRES movegrid=0 resizegrid=0 showgrid=0 gridcolor=Cyan
$STOREDISPLAY Append
...
OFDP type="FLOAT" width=6 prec=1 label="Oil Flt DP" units="default" 
$END-OBJECT
***********
$OBJECT Button font=98 displayflag=EngineNotRunning startx=24 starty=497 endx=218 endy=571
...
$END-OBJECT
***********
$OBJECT Button font=98 startx=26 starty=415 endx=220 endy=489
...
$END-OBJECT
***********
$OBJECT Buttonobj font=101 startx=228 starty=458 endx=349 endy=540
