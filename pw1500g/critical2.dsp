$DISPLAY "Critical2" background=DarkGray editres=FHD movegrid=0 resizegrid=0 showgrid=0 gridcolor=Cyan
$MSGQ
$STOREDISPLAY Append
...
$END-OBJECT
***********
$OBJECT String font=101 startx=230 starty=2 endx=458 endy=33
...
$END-OBJECT
***********
$OBJECT StatusIndicator font=97 startx=1481 starty=872 endx=1917 endy=920
...
$END-OBJECT
***********
$OBJECT Box font=1 startx=1488 starty=44 endx=1893 endy=339
style=2
boxcolor=DarkGray
shading=2
$END-OBJECT
***********
$OBJECT StatusIndicator font=100 startx=1489 starty=352 endx=1694 endy=440
...
$END-OBJECT
***********
$OBJECT StatusIndicator font=2 startx=1495 starty=443 endx=1625 endy=521
...
$END-OBJECT
***********
$OBJECT String font=100 startx=1496 starty=884 endx=1606 endy=907
...
$END-OBJECT
***********
$OBJECT Digital font=101 startx=1505 starty=301 endx=1909 endy=333
labelspace=8 unitspace=1 spacing=1 labelcolor=Black parambox=2 paramboxcolor=Black shading=-2
AOP type="FLOAT" width=7 prec=1 label="FGB Aux MOP:" units="default" 
$END-OBJECT
***********
...
$END-OBJECT
***********
$OBJECT Digital font=103 startx=1543 starty=718 endx=1862 endy=850
labelspace=7 unitspace=1 spacing=10 labelcolor=Black parambox=2 paramboxcolor=Black shading=-2
...
$END-OBJECT
***********
$OBJECT Text font=103 displayflag=Met4_F startx=1598 starty=556 endx=1814 endy=676
...
$END-OBJECT
***********
$OBJECT StatusIndicator font=100 startx=1695 starty=352 endx=1900 endy=440
