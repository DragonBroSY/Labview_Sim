$DISPLAY "Final DSU Check FHD" background=DarkGray loadflag=ctrlFHD_F editres=FHD movegrid=0 resizegrid=0 showgrid=0 gridcolor=Cyan
$INITCALC
...
$END-OBJECT
***********
$OBJECT Box font=101 startx=747 starty=11 endx=1121 endy=68
style=3
...
$END-OBJECT
***********
$OBJECT Text font=96 displayflag=CustDSUInst_F startx=773 starty=22 endx=1100 endy=61
