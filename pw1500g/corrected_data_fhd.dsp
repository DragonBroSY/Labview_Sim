$DISPLAY "Corrected Data FHD" background=LightGray loadflag=ctrlFHD_F editres=FHD movegrid=0 resizegrid=0 showgrid=0 gridcolor=Cyan
$STOREDISPLAY Append
...
$END-OBJECT
***********
$OBJECT Box font=1 startx=400 starty=0 endx=710 endy=48
style=3
...
$END-OBJECT
***********
$OBJECT Text font=96 startx=425 starty=4 endx=702 endy=43
