...
+0 SET FNTR2_TargMx lookup (AcceptFNTR2Targ_T)
+0 SET FNTR2_TargMn (FNTR2_TargMx - 500.0)
...
+0 SET FNTR2_TargMx lookup (CorrFNTR2Targ_T)
+0 SET FNTR2_TargMn (FNTR2_TargMx - 500.0)
...
+0 SET TLA_Targ 0.0
+0 SET StageTmrLim 1.0
#elseif ArmVibSurvey_TB
+0 SET N1C2_Targ lookup (VibSvyN1C2Targ_T)
+0 SET TLA_Targ lookup (VibSvyTLATarg_T)
+0 SET StageTmrLim lookup (VibSvyEventDur_T)
+0 SET StepTxt concat ("Step " VibSvyStep)
+0 SET StepTxt concat (StepTxt ": ")
#elseif ArmShapedPart10_TS
+0 SET N1C2_Targ lookup (Shaped10N1C2Targ_T)
+0 SET TLA_Targ lookup (Shaped10TLATarg_T)
+0 SET StageTmrLim lookup (Shaped10EventDur_T)
+0 SET StepTxt concat ("Step " ShapedStep)
+0 SET StepTxt concat (StepTxt ": ")
#elseif ArmShapedPart15_TS
+0 SET N1C2_Targ lookup (Shaped15N1C2Targ_T)
+0 SET TLA_Targ lookup (Shaped15TLATarg_T)
+0 SET StageTmrLim lookup (Shaped15EventDur_T)
+0 SET StepTxt concat ("Step " ShapedStep)
+0 SET StepTxt concat (StepTxt ": ")
#elseif ArmShapedPart20_TS
+0 SET N1C2_Targ lookup (Shaped20N1C2Targ_T)
+0 SET TLA_Targ lookup (Shaped20TLATarg_T)
+0 SET StageTmrLim lookup (Shaped20EventDur_T)
+0 SET StepTxt concat ("Step " ShapedStep)
+0 SET StepTxt concat (StepTxt ": ")
...
*+0 SET TRADecelMx 0.0
*+0 SET TRADecelMn 0.0
*+0 SET TRAAccelMx 0.0
*+0 SET TRAAccelMn 0.0
#endif
...
+0 SET TRAAccelTarg (TRA_TargMn - 1.3)
#elseif	(Accel_F & (TRA_Rate < 40.0))
+0 SET TRAAccelTarg (TRA_TargMn - 1.6)
#elseif	(Accel_F & (TRA_Rate >= 40.0))
+0 SET TRAAccelTarg (TRA_TargMn - 2.0)
#endif
...
+0 SET TRADecelTarg (TRA_TargMx + 1.3)
#elseif	(Decel_F & (TRA_Rate < 40.0))
+0 SET TRADecelTarg (TRA_TargMx + 1.6)
#elseif	(Decel_F & (TRA_Rate >= 40.0))
+0 SET TRADecelTarg (TRA_TargMx + 2.0)
#endif
*#if	(AutoTLAEnable_F)
*+0 SET TRAAccelTarg TRA_Targ
*+0 SET TRADecelTarg TRA_Targ
*#endif
$END-PHASE
**********
