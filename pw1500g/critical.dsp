...
$END-OBJECT
***********
$OBJECT Bar font=101 displayflag=NotRunMode startx=6 starty=280 endx=958 endy=336
labelspace=5 unitspace=0 labelcolor=Black length=750 \
height=15 format=5.0 ticpos=BELOW dir=0 shading=-2 spacing=1 \
ticfont=2 parambox=2 paramboxcolor=Black limitwidth=4
EEC_Wf label="Wf Qec" min=0 max=4000 ticinter=125 labelinter=2
$END-OBJECT
***********
$OBJECT Bar font=101 displayflag=RunMode startx=6 starty=280 endx=958 endy=336
labelspace=5 unitspace=0 labelcolor=Black length=750 \
height=15 format=5.0 ticpos=BELOW dir=0 shading=-2 spacing=1 \
ticfont=2 parambox=2 paramboxcolor=Black limitwidth=4
WfI label="Wf" min=0 max=8000 ticinter=250 labelinter=2
$END-OBJECT
***********
