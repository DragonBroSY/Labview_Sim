$DISPLAY "Trim Balance Info" background=DarkGray editres=MEDRES movegrid=0 resizegrid=0 showgrid=0 gridcolor=Cyan
$CALC
#if	ResetPeakTBData_PB
VibFNFPkTB:IPS	0.0
...
PUSH ResetPeakTBData_PB setvalue=-1 onlabel="Reset Peak TB Data" offlabel="Reset Peak TB Data" \
