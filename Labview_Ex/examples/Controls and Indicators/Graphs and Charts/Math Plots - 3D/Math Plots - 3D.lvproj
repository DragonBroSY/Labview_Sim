...
<Project Type="Project" LVVersion="23008000">
	...
	<Property Name="NI.Project.Description" Type="Str">Contains examples illustrating the functionality and use of the 3D Math Plots on the Graph &gt; 3D Graph palette.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="3D Bar Graph.vi" Type="VI" URL="../3D Bar Graph.vi"/>
		<Item Name="3D Comet Graph.vi" Type="VI" URL="../3D Comet Graph.vi"/>
		<Item Name="3D Contour Graph.vi" Type="VI" URL="../3D Contour Graph.vi"/>
		<Item Name="3D Mesh Graph.vi" Type="VI" URL="../3D Mesh Graph.vi"/>
		<Item Name="3D Pie Graph.vi" Type="VI" URL="../3D Pie Graph.vi"/>
		<Item Name="3D Quiver Graph.vi" Type="VI" URL="../3D Quiver Graph.vi"/>
		<Item Name="3D Ribbon Graph.vi" Type="VI" URL="../3D Ribbon Graph.vi"/>
		<Item Name="3D Scatter Graph.vi" Type="VI" URL="../3D Scatter Graph.vi"/>
		<Item Name="3D Stem Graph.vi" Type="VI" URL="../3D Stem Graph.vi"/>
		<Item Name="3D Surface Graph.vi" Type="VI" URL="../3D Surface Graph.vi"/>
		<Item Name="3D Waterfall Graph.vi" Type="VI" URL="../3D Waterfall Graph.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="3D Waterfall Datatype.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Math Plots/3D Math Plots/3D Waterfall/3D Waterfall Datatype/3D Waterfall Datatype.lvclass"/>
				<Item Name="3D Waterfall.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Math Plots/3D Math Plots/3D Waterfall/3D Waterfall/3D Waterfall.lvclass"/>
				<Item Name="3D Waterfall.xctl" Type="XControl" URL="/&lt;vilib&gt;/Math Plots/3D Math Plots/3D Waterfall/3D Waterfall XCtrl/3D Waterfall.xctl"/>
