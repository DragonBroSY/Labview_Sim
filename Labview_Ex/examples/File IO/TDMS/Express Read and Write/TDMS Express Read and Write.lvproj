...
<Project Type="Project" LVVersion="23008000">
	...
	<Property Name="NI.Project.Description" Type="Str">Contains examples pertaining to use Express VIs for TDMS writing and reading.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="TDMS Express Read Data (Time Domain).vi" Type="VI" URL="../TDMS Express Read Data (Time Domain).vi"/>
		<Item Name="TDMS Express Write Data (Time and Frequency Domain).vi" Type="VI" URL="../TDMS Express Write Data (Time and Frequency Domain).vi"/>
		<Item Name="TDMS Express Write Data (Time Domain).vi" Type="VI" URL="../TDMS Express Write Data (Time Domain).vi"/>
