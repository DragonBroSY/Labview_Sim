...
&lt;nidna:ExampleProgram 
    ...
    ContentType="EXAMPLE" 
&lt;Title&gt;
	&lt;Text Locale="US"&gt;TDM Event Data.lvproj&lt;/Text&gt;
&lt;/Title&gt;
&lt;Description&gt;
	&lt;Text Locale="US"&gt; Writes event data to a TDM file, then reads that event data from the same file. The file will contain regular acquired channel data, but will also contain event data that is added at random points during the acquisition. During the simulated measurement, random events will cause the VI to calculate a power spectrum on the most recent data package and to store it to a new data channel. Two additional data channels are created to store time stamps of the event occurrences and text descriptions of the events.&lt;/Text&gt;
&lt;/Description&gt;
&lt;Keywords&gt; 
 &lt;Item&gt;file&lt;/Item&gt; 
 &lt;Item&gt;events&lt;/Item&gt; 
...
&lt;/RequiredSoftware&gt;</Property>
	<Property Name="NI.Project.Description" Type="Str">Writes event data to a TDM file, then reads that event data from the same file. The file will contain regular acquired channel data, but will also contain event data that is added at random points during the acquisition. During the simulated measurement, random events will cause the VI to calculate a power spectrum on the most recent data package and to store it to a new data channel. Two additional data channels are created to store time stamps of the event occurrences and text descriptions of the events.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Write TDM Event Data.vi" Type="VI" URL="../Write TDM Event Data.vi"/>
		<Item Name="Read TDM Event Data.vi" Type="VI" URL="../Read TDM Event Data.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="__saveInt32Channel.vi" Type="VI" URL="/&lt;vilib&gt;/Platform/storage/lvStorage.llb/__saveInt32Channel.vi"/>
				<Item Name="_loadAllString.vi" Type="VI" URL="/&lt;vilib&gt;/Platform/storage/lvStorage.llb/_loadAllString.vi"/>
