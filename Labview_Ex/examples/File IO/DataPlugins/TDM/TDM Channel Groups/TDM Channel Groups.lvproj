...
&lt;nidna:ExampleProgram 
    ...
    ContentType="EXAMPLE" 
&lt;Title&gt;
	&lt;Text Locale="US"&gt;TDM Channel Groups.lvproj&lt;/Text&gt;
&lt;/Title&gt;
&lt;Description&gt;
	&lt;Text Locale="US"&gt; Writes channel groups to a TDM file, then reads those groups from the same file. The file will contain properties (title, author, etc.), and will also contain channel data grouped into channel groups.&lt;/Text&gt;
&lt;/Description&gt;
&lt;Keywords&gt; 
 &lt;Item&gt;storage&lt;/Item&gt; 
 &lt;Item&gt;data&lt;/Item&gt; 
...
&lt;/RequiredSoftware&gt;</Property>
	<Property Name="NI.Project.Description" Type="Str">Writes channel groups to a TDM file, then reads those groups from the same file. The file will contain properties (title, author, etc.), and will also contain channel data grouped into channel groups.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Write TDM Channel Groups.vi" Type="VI" URL="../Write TDM Channel Groups.vi"/>
		<Item Name="Read TDM Channel Groups.vi" Type="VI" URL="../Read TDM Channel Groups.vi"/>
