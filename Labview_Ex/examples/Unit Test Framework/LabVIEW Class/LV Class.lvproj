...
&lt;ExampleProgram&gt;
&lt;Title&gt;
	&lt;Text Locale="US"&gt;LV Class.lvproj&lt;/Text&gt;
&lt;/Title&gt;
&lt;Keywords&gt;
	&lt;Item&gt;unit&lt;/Item&gt;
	&lt;Item&gt;test&lt;/Item&gt;
...
&lt;/ExampleProgram&gt;</Property>
	<Property Name="NI.Project.Description" Type="Str">Demonstrates how to use the LabVIEW Unit Test Framework Toolkit to test VIs that use LabVIEW Class. The project contains three examples respectively in the &lt;B&gt;Parent&lt;/B&gt;, &lt;B&gt;Child&lt;/B&gt;, and &lt;B&gt;Class with reference&lt;/B&gt; virtual folders.
Refer to &lt;B&gt;Readme.txt&lt;/B&gt; in the LabVIEW\examples\Unit Test Framework\LabVIEW Class directory for the detailed descriptions.</Property>
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Parent" Type="Folder">
			...
			<Item Name="Parent Class Setup.vi" Type="VI" URL="../Parent/Parent Class Setup.vi"/>
			<Item Name="Parent Class Teardown.vi" Type="VI" URL="../Parent/Parent Class Teardown.vi"/>
			<Item Name="Add Prefix.lvtest" Type="TestItem" URL="../Parent/Add Prefix.lvtest">
				<Property Name="utf.test.bind" Type="Str">Parent.lvclass:Add Prefix.vi</Property>
				<Property Name="utf.vector.test.bind" Type="Str">478961A3-686F-97AC-47E9-72F97BAA0CC3</Property>
			</Item>
		</Item>
		<Item Name="Child" Type="Folder">
			<Item Name="Child.lvclass" Type="LVClass" URL="../Child/Child.lvclass"/>
			<Item Name="Get Class Object.vi" Type="VI" URL="../Child/Get Class Object.vi"/>
			<Item Name="Dynamic Dispatch Method.lvtest" Type="TestItem" URL="../Child/Dynamic Dispatch Method.lvtest">
				<Property Name="utf.test.bind" Type="Str">Child.lvclass:Dynamic Dispatch Method.vi</Property>
				<Property Name="utf.vector.test.bind" Type="Str">CD4FC7DA-BC8B-121F-52D9-2CD2B850C0DA</Property>
			</Item>
		</Item>
		<Item Name="Class with reference" Type="Folder">
			<Item Name="Read File.lvclass" Type="LVClass" URL="../Class with reference/Read File.lvclass"/>
			<Item Name="Setup for Get File Content.vi" Type="VI" URL="../Class with reference/Setup for Get File Content.vi"/>
			<Item Name="Teardown for Get File Content.vi" Type="VI" URL="../Class with reference/Teardown for Get File Content.vi"/>
			<Item Name="Get File Content.lvtest" Type="TestItem" URL="../Class with reference/Get File Content.lvtest">
				<Property Name="utf.test.bind" Type="Str">Read File.lvclass:Get File Content.vi</Property>
				<Property Name="utf.vector.test.bind" Type="Str">76762871-DD00-8BEB-6308-849BEE70A927</Property>
			</Item>
		</Item>
