...
&lt;/ExampleProgram&gt;</Property>
	<Property Name="NI.Project.Description" Type="Str">This project demonstrates how to apply a fixed-point LMS adaptive filter on LabVIEW FPGA to adaptive noise cancellation (ANC) applications. This example was created and precompiled by using an NI 9234 module in slot 1 of a cRIO-9033 backplane. For more information about moving this example to another FPGA target, visit ni.com/info and enter the info code fpgaex.
...
This example acquires two channels of signals through NI 9234. The AI1 channel acquires the sound corrupted by noise. The AI0 channel acquires the background noise as reference.

Complete the following steps to use this example.

1. Prepare necessary hardware. You need an NI CompactRIO chassis, controller, NI 9234 module, and two microphones. Plug the NI cRIO-9234 module into slot 1 of the CompactRIO chassis. Connect the microphones to AI0 and AI1 of the NI 9234 module. Place the microphone that is connected to AI1 close to the sound of interest. Place the other microphone away from the sound of interest to acquire the backgound noise.
