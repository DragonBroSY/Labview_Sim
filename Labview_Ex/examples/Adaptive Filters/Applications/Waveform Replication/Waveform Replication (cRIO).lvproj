...
&lt;/ExampleProgram&gt;</Property>
	<Property Name="NI.Project.Description" Type="Str">This example demonstrates how to apply an LMS adaptive filter to road simulation applications by using NI CompactRIO hardware. This example was created and precompiled by using an NI 9234 module in slot 1 and an NI 9263 module in slot 2 of a cRIO-9033 backplane. For more information about moving this example to another FPGA target, visit ni.com/info and enter the info code fpgaex. 

Road simulation is to replicate a vibration waveform by a shakerThis example uses the NI 9234 module to acquire the actual vibration of the shaker, implements the LMS-based control algorithm with LabVIEW FPGA, and uses the NI 9263 module to generate a driving signal for the shaker. With the closed-loop control, the shaker produces expected waveforms exactly. 

Complete the following steps to use this example.

1. Prepare necessary hardware. You need an NI CompactRIO chassis, controller, NI 9234 module, NI 9263 module, and an accelerometer. Plug the NI 9234 module into slot 1 and the NI 9263 module into slot 2 of the CompactRIO chassis. Connect the accelerometer to the AI0 channel of the NI 9234 module. Connect the AO0 channel of the NI 9263 module to the amplifier of the shaker. Fix the accelerometer on the shaker.
