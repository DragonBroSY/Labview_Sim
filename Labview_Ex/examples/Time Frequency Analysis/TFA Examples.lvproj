...
<Project Type="Project" LVVersion="23008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Applications" Type="Folder">
			<Item Name="Blood Flow Measurement.vi" Type="VI" URL="../TFAApplications/Blood Flow Measurement.vi"/>
			<Item Name="Chirplet TDR.vi" Type="VI" URL="../TFAApplications/Chirplet TDR.vi"/>
			<Item Name="Heart Sound TFA.vi" Type="VI" URL="../TFAApplications/Heart Sound TFA.vi"/>
			<Item Name="Liquefaction Detection.vi" Type="VI" URL="../TFAApplications/Liquefaction Detection.vi"/>
			<Item Name="Offline Noise Reduction with Time Varying Filter.vi" Type="VI" URL="../TFAApplications/Offline Noise Reduction with Time Varying Filter.vi"/>
			<Item Name="Online Noise Reduction.vi" Type="VI" URL="../TFAApplications/Online Noise Reduction.vi"/>
			<Item Name="Online Pitch Shifting.vi" Type="VI" URL="../TFAApplications/Online Pitch Shifting.vi"/>
			<Item Name="Sine Curve Fitting.vi" Type="VI" URL="../TFAApplications/Sine Curve Fitting.vi"/>
			<Item Name="Voice Enhancement.vi" Type="VI" URL="../TFAApplications/Voice Enhancement.vi"/>
		</Item>
		<Item Name="Getting Started" Type="Folder">
			<Item Name="Adaptive Transform (ADT) and Adaptive Expansion (ADE).vi" Type="VI" URL="../TFAFunctions/Adaptive Transform (ADT) and Adaptive Expansion (ADE).vi"/>
			<Item Name="Color Tables for Displaying the Spectrogram.vi" Type="VI" URL="../TFAGettingStarted/Color Tables for Displaying the Spectrogram.vi"/>
			<Item Name="Cross Term.vi" Type="VI" URL="../TFAGettingStarted/Cross Term.vi"/>
			<Item Name="Dual Function.vi" Type="VI" URL="../TFAGettingStarted/Dual Function.vi"/>
			<Item Name="Gabor Transform and Expansion.vi" Type="VI" URL="../TFAFunctions/Gabor Transform and Expansion.vi"/>
			<Item Name="Group Delay.vi" Type="VI" URL="../TFAFunctions/Group Delay.vi"/>
			<Item Name="Linear JTFA Method.vi" Type="VI" URL="../TFAGettingStarted/Linear JTFA Method.vi"/>
			<Item Name="Marginal Condition.vi" Type="VI" URL="../TFAFunctions/Marginal Condition.vi"/>
			<Item Name="Mean Instantaneous Frequency or Bandwidth (MIF or MIB).vi" Type="VI" URL="../TFAFunctions/Mean Instantaneous Frequency or Bandwidth (MIF or MIB).vi"/>
			<Item Name="Online Spectrogram Monitoring (DAQmx).vi" Type="VI" URL="../TFAFunctions/Online Spectrogram Monitoring (DAQmx).vi"/>
			<Item Name="Online Spectrogram Monitoring (Simulated).vi" Type="VI" URL="../TFAFunctions/Online Spectrogram Monitoring (Simulated).vi"/>
			<Item Name="Online Spectrogram Monitoring (Sound Card).vi" Type="VI" URL="../TFAFunctions/Online Spectrogram Monitoring (Sound Card).vi"/>
			<Item Name="Pseudo Wigner-Ville Distribution.vi" Type="VI" URL="../TFAFunctions/Pseudo Wigner-Ville Distribution.vi"/>
			<Item Name="Quadratic JTFA Method.vi" Type="VI" URL="../TFAGettingStarted/Quadratic JTFA Method.vi"/>
			<Item Name="The Need for JTFA.vi" Type="VI" URL="../TFAGettingStarted/The Need for JTFA.vi"/>
			<Item Name="Time Varying Filter.vi" Type="VI" URL="../TFAFunctions/Time Varying Filter.vi"/>
			<Item Name="Time-Frequency Resolution.vi" Type="VI" URL="../TFAGettingStarted/Time-Frequency Resolution.vi"/>
		</Item>
		<Item Name="Support VIs" Type="Folder">
			<Item Name="Helper SubVI - Generate Chirplet Parameters.vi" Type="VI" URL="../Support VIs/Helper SubVI - Generate Chirplet Parameters.vi"/>
			<Item Name="Helper SubVI - Generate Chirplet.vi" Type="VI" URL="../Support VIs/Helper SubVI - Generate Chirplet.vi"/>
			<Item Name="Helper SubVI - Get Reflectance from Chirplet Parameters.vi" Type="VI" URL="../Support VIs/Helper SubVI - Get Reflectance from Chirplet Parameters.vi"/>
			<Item Name="Helper SubVI - Phase Vocoder.vi" Type="VI" URL="../Support VIs/Helper SubVI - Phase Vocoder.vi"/>
			<Item Name="Helper SubVI - PWVD Kernel.vi" Type="VI" URL="../Support VIs/Helper SubVI - PWVD Kernel.vi"/>
			<Item Name="Helper SubVI - Signal Sweep (tfa).vi" Type="VI" URL="../Support VIs/Helper SubVI - Signal Sweep (tfa).vi"/>
			<Item Name="Helper SubVI - Sine Curve Fitting Core.vi" Type="VI" URL="../Support VIs/Helper SubVI - Sine Curve Fitting Core.vi"/>
			<Item Name="Helper SubVI - Sine Curve Fitting Prepare.vi" Type="VI" URL="../Support VIs/Helper SubVI - Sine Curve Fitting Prepare.vi"/>
			<Item Name="Helper SubVI - Spectral Subtraction.vi" Type="VI" URL="../Support VIs/Helper SubVI - Spectral Subtraction.vi"/>
			<Item Name="Helper SubVI - TDR Signal Simulation.vi" Type="VI" URL="../Support VIs/Helper SubVI - TDR Signal Simulation.vi"/>
			<Item Name="Helper SubVI - Vector Interpolation.vi" Type="VI" URL="../Support VIs/Helper SubVI - Vector Interpolation.vi"/>
			<Item Name="Helper SubVI - Wrap to Power of 2.vi" Type="VI" URL="../Support VIs/Helper SubVI - Wrap to Power of 2.vi"/>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="tfa Time Varying Filter Menu.rtm" Type="Document" URL="/&lt;vilib&gt;/addons/Time Frequency Analysis/Application.llb/tfa Time Varying Filter Menu.rtm"/>
